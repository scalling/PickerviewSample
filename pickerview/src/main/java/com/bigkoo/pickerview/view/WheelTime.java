...
//                maxItem = endD;
    ...
    public void setItemCount(int count){
        wv_year.setItemCount(count);
        wv_month.setItemCount(count);
        wv_day.setItemCount(count);
        wv_hours.setItemCount(count);
        wv_minutes.setItemCount(count);
        wv_seconds.setItemCount(count);
    }
}
