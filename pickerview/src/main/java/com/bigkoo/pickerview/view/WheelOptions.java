...
//            wv_option1.setOnItemSelectedListener(wheelListener_option1);
//        else
//            wv_option1.setOnItemSelectedListener(change);
//        if (options3Items != null && linkage)
//            wv_option2.setOnItemSelectedListener(wheelListener_option2);
//        else
//            wv_option2.setOnItemSelectedListener(change);

        wv_option3.setOnItemSelectedListener(change);
    }

    private  OnItemSelectedListener change= new OnItemSelectedListener() {
        @Override
        public void onItemSelected(int index) {
            change();
        }
